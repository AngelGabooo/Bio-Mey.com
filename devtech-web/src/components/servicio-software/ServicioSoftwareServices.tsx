...
const ServicioSoftwareServices = () => {
  useEffect(() => {
    AOS.init({
      duration: 800,
      once: true,
  ...
  const services = [
    {
      ...
      description: 'Instalamos y configuramos Windows en todas sus versiones (10, 11, etc.).',
      icon: (
    ...
    },
    {
      ...
      description: 'Instalamos los drivers necesarios para que todo funcione correctamente.',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Instalación de Microsoft Office (Word, Excel, PowerPoint, Outlook, etc.).',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Instalamos software según tus necesidades: diseño, ingeniería, contabilidad y más.',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Protegemos tu equipo con antivirus confiables y actualizados.',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Instalación y configuración de impresoras, escáneres y multifuncionales.',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.6} d="M9 3v2m6-2v2M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2zM7 12h10M7 16h4" />
        </svg>
      ),
    },
    {
      title: 'Actualizaciones',
      description: 'Actualizamos tu sistema y programas para mayor seguridad y rendimiento.',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.6} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
        </svg>
    ...
    },
    {
      ...
      description: 'Optimizamos tu equipo para que funcione más rápido y de forma estable.',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default ServicioSoftwareServices;