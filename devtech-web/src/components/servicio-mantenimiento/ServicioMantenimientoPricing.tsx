...
${form.mensaje}
  ...
  return (
    <section ref={sectionRef} className="relative py-10 md:py-16 bg-white overflow-hidden" id="paquetes">
      ...
      <div className="container-custom relative z-10 max-w-6xl mx-auto px-5">
        ...
        >
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 md:p-8">
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-1">¿Qué influye en el precio</h3>
            <h3 className="text-xl md:text-2xl font-bold mb-6">
              <span className="text-cyan-500">de un mantenimiento?</span>
            </h3>
