...
const ServicioMantenimientoPackages = () => {
  ...
  const accentStyles = {
    purple: {
      ...
      iconBg: 'from-purple-600/30 to-purple-500/10',
      iconText: 'text-purple-300',
      subtitle: 'text-purple-300/80',
      check: 'text-purple-400',
      noteBorder: 'border-purple-400/20',
      noteBg: 'bg-purple-600/5',
    ...
    blue: {
      ...
      check: 'text-blue-400',
      noteBorder: 'border-blue-400/20',
      noteBg: 'bg-blue-600/5',
      noteIcon: 'text-blue-400',
    ...
    <section className="relative py-10 md:py-16 bg-[#0a0a14] overflow-hidden">
      ...
      <div className="container-custom relative z-10 max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-center gap-4 md:gap-10 mb-8 md:mb-10">
          ...
          <div className="hidden md:flex relative shrink-0 items-center justify-center w-32 h-32 lg:w-40 lg:h-40">
            ...
            <div className="relative w-full h-full rounded-full border border-purple-400/20 flex items-center justify-center">
              <div className="w-20 h-20 lg:w-24 lg:h-24 rounded-2xl border-2 border-purple-400/50 flex items-center justify-center bg-purple-600/5">
                <svg className="w-10 h-10 lg:w-12 lg:h-12 text-purple-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                </svg>
              </div>
              <span className="absolute -bottom-2 -right-2 w-9 h-9 rounded-full bg-[#0a0a14] border border-purple-400/40 flex items-center justify-center text-purple-300">
          ...
          {/* Ilustración derecha: reparación */}
          <div className="hidden md:flex relative shrink-0 items-center justify-center w-32 h-32 lg:w-40 lg:h-40">
            <div className="absolute inset-0 rounded-full bg-blue-600/10 blur-2xl"></div>
            <div className="relative w-full h-full rounded-full border border-blue-400/20 flex items-center justify-center">
              <div className="w-20 h-20 lg:w-24 lg:h-24 rounded-2xl border-2 border-blue-400/50 flex items-center justify-center bg-blue-600/5">
                <svg className="w-10 h-10 lg:w-12 lg:h-12 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="absolute -bottom-2 -left-2 w-9 h-9 rounded-full bg-[#0a0a14] border border-blue-400/40 flex items-center justify-center text-blue-300">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div
          ...
          data-aos-duration="600"
        >
          <div className="flex items-start gap-3 px-5 py-4 rounded-2xl bg-white/5 border border-white/10">
            <span className="shrink-0 w-10 h-10 rounded-full border border-purple-400/40 flex items-center justify-center text-purple-300">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <p className="text-white font-semibold text-sm">No trabajamos con precios fijos.</p>
              <p className="text-blue-200/50 text-xs mt-1 max-w-xs">
          ...
          <div className="flex items-start gap-3 px-5 py-4 rounded-2xl bg-white/5 border border-white/10">
            ...
            <div>
              <p className="text-white font-semibold text-sm">Transparencia total</p>
              <p className="text-blue-200/50 text-xs mt-1 max-w-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {packages.map((pkg, index) => {
            ...
            return (
              <div
                key={pkg.id}
                className={`group flex flex-col bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 ${styles.hoverBorder} transition-all duration-300 hover:shadow-lg ${styles.hoverShadow} hover:-translate-y-1 p-6 md:p-8`}
                data-aos="fade-up"
              ...
              >
                ...
                <ul className="space-y-2.5 mb-5 flex-1">
                  {pkg.features.map((feature, i) => (
                    <li key={i} className="flex items-start gap-2 text-blue-200/70 text-sm">
                ...
                <div className={`flex items-start gap-2.5 px-4 py-3 rounded-xl border ${styles.noteBorder} ${styles.noteBg}`}>
                  ...
                  <p className="text-blue-200/70 text-xs leading-relaxed">{pkg.note}</p>
                </div>
              </div>
            );
          })}
        ...
        {/* Barra inferior: importante + garantía */}
        <div
          className="mt-10 md:mt-12 rounded-2xl bg-gradient-to-r from-blue-600/10 to-purple-600/10 border border-blue-400/20 overflow-hidden"
          data-aos="fade-up"
          data-aos-delay="300"
          data-aos-duration="600"
        >
          <div className="flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-white/10">
            <div className="flex items-start md:items-center gap-3 p-5 md:p-6 flex-1">
              <span className="shrink-0 w-11 h-11 rounded-full border border-purple-400/40 flex items-center justify-center text-purple-300">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
                </svg>
              </span>
              <div>
                <span className="text-white font-semibold text-sm">Importante</span>
