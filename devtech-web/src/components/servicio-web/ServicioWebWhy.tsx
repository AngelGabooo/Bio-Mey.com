  ...
  const benefits = [
    {
      ...
      accent: 'border-cyan-400/40 text-cyan-500',
      glow: 'from-cyan-50 via-white',
      span: 'xl:col-span-2',
      hero: true,
      icon: (
    ...
    <section className="relative py-16 md:py-24 bg-white overflow-hidden" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="container-custom relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Reveal className="text-center mb-12 md:mb-16">
          ...
          >
            ¿Por qué elegir{' '}
            <span className="text-cyan-500">BioMey</span>
            ?
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-5 auto-rows-fr">
          {benefits.map((benefit, index) => (
            <Reveal
              key={benefit.id}
              delay={index * 70}
              className={`group relative overflow-hidden rounded-2xl border border-gray-200 bg-white hover:border-cyan-300 hover:shadow-lg hover:shadow-cyan-500/5 transition-all duration-300 ${benefit.span || ''} ${
            ...
            >
              ...
              <span
                aria-hidden="true"
                className="pointer-events-none absolute -bottom-3 -right-1 text-gray-100 select-none leading-none"
              ...
              {benefit.hero ? (
                <>
                  ...
                  <div className="relative z-10">
                    ...
                    <span
                      className="block text-xs text-cyan-500/70 tracking-widest mb-2"
                      style={{ fontFamily: "'JetBrains Mono', monospace" }}
                    >
                      N.º {benefit.num}
                    </span>
                    <h3
                      className="text-gray-900 font-semibold text-2xl md:text-3xl mb-2"
                      style={{ fontFamily: "'Space Grotesk', sans-serif" }}
                    >
                      {benefit.title}
                    </h3>
                ...
                <>
                  ...
                  <div className="relative z-10 min-w-0 flex-1 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-4">
                    <div>
                      <h3 className="text-gray-900 font-semibold text-base md:text-lg">{benefit.title}</h3>
                      <p className="text-gray-500 text-sm">{benefit.description}</p>
                    </div>
                    <span
                      className="hidden sm:inline text-xs text-cyan-500/50 tracking-widest whitespace-nowrap"
                      style={{ fontFamily: "'JetBrains Mono', monospace" }}
                    >
                      N.º {benefit.num}
                    </span>
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-gray-900 font-semibold text-base md:text-lg mb-1.5">{benefit.title}</h3>
        ...
        <Reveal delay={480} className="text-center mt-12 md:mt-16">
          <a
            href="#paquetes"
            className="inline-flex items-center gap-2 px-8 py-4 text-white font-semibold rounded-full bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 transition-all duration-300 shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 hover:scale-105 transform"
          >
