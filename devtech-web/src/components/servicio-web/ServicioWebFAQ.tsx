  ...
  const faqs = [
    {
      ...
      answer: 'Sí, en nuestros paquetes de Página Web para Negocios, Profesional y Empresarial incluimos dominio .com y hosting por 1 año. Para el paquete Landing Page, ofrecemos la opción de agregarlos por un costo adicional.'
    },
    {
      question: '¿Puedo solicitar cambios en el diseño?',
      answer: '¡Por supuesto! Incluimos rondas de cambios en todos nuestros paquetes. Dependiendo del paquete que elijas, tendrás entre 1 y 5 rondas de cambios para ajustar el diseño a tus necesidades y preferencias.'
    },
    {
      question: '¿Mi página web será autoadministrable?',
      answer: 'Sí, en nuestros paquetes Profesional y Empresarial incluimos un panel administrativo (CMS) que te permite actualizar el contenido de tu página de forma sencilla, sin necesidad de conocimientos técnicos.'
    },
    {
      question: '¿Cuánto tiempo tarda en estar lista mi página?',
      answer: 'El tiempo de entrega varía según el paquete: Landing Page en 5 días, Página para Negocios en 7 días, Página Profesional en 12 días y Página Empresarial en 15 días. Estos plazos pueden ajustarse según la complejidad del proyecto.'
    },
    {
      question: '¿Ofrecen soporte después de entregar la página?',
      answer: 'Sí, ofrecemos soporte post-lanzamiento. En los paquetes Profesional y Empresarial incluimos 30 y 60 días de soporte respectivamente. También ofrecemos planes de mantenimiento web mensual para soporte continuo.'
    }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <p className="text-blue-200/60 text-base md:text-lg mb-8">
              Resolvemos tus dudas sobre la creación de tu página web
            </p>
