        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {services.map((service, index) => (
            <div
              ...
              data-aos-duration="600"
            >
              {/* Icono con glow similar al Hero */}
              <div className="relative">
                ...
                <div className="relative w-14 h-14 rounded-xl bg-gradient-to-r from-blue-600/20 to-purple-600/20 flex items-center justify-center mb-4 text-blue-400 group-hover:text-blue-300 transition-colors duration-300 border border-blue-400/20">
                  {service.icon}
                </div>
              </div>
              ...
              {/* Descripción */}
              <p className="text-blue-200/60 text-sm md:text-base leading-relaxed mb-4">
                {service.description}
              </p>

              {/* Enlace "Ver más" con efecto similar al Hero - usando Link de react-router */}
              <Link
                to={service.link}
                className="inline-flex items-center gap-2 text-blue-400 hover:text-blue-300 transition-all duration-300 text-sm font-medium group-hover:gap-3"
              >
                Ver más
