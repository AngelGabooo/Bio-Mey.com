...
const ServicioSoporteFAQ = () => {
  ...
  const faqs = [
    {
      question: '¿Qué tipos de problemas pueden resolver?',
      answer: 'Atendemos todo tipo de problemas técnicos: fallas de hardware, errores de software, virus y malware, problemas de red, configuración de dispositivos, optimización de sistemas, recuperación de datos y más. Si tu equipo tiene un problema, nosotros lo solucionamos.'
    },
    {
      question: '¿Ofrecen soporte remoto o solo presencial?',
      answer: 'Ambos. Contamos con soporte remoto seguro para problemas de software y configuraciones, y también ofrecemos soporte presencial en tu domicilio u oficina para fallas de hardware y revisiones físicas.'
    },
    {
      question: '¿Cuánto tiempo tardan en resolver un problema?',
      answer: 'El tiempo varía según la complejidad del problema. Problemas de software simples pueden resolverse en 1-2 horas, mientras que reparaciones de hardware más complejas pueden tomar 24-48 horas. Siempre te damos un estimado después del diagnóstico.'
    },
    {
      question: '¿Qué marcas de equipos atienden?',
      answer: 'Atendemos todas las marcas: HP, Dell, Lenovo, ASUS, Acer, MSI, Apple, y cualquier otra. Trabajamos con equipos de escritorio, laptops, all-in-one y servidores de cualquier fabricante.'
    },
    {
      question: '¿Cuánto cuesta el servicio de soporte técnico?',
      answer: 'El costo depende del tipo de servicio y la complejidad del problema. Ofrecemos precios competitivos y cotizamos sin compromiso después de un diagnóstico inicial. Contamos con paquetes para diferentes necesidades.'
    },
    {
      question: '¿Tienen garantía en sus reparaciones?',
      answer: 'Sí, todas nuestras reparaciones y servicios cuentan con garantía. Si el mismo problema vuelve a aparecer dentro del período de garantía, lo resolvemos sin costo adicional.'
    }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <p className="text-blue-200/60 text-base md:text-lg mb-8">
              Resolvemos las dudas más comunes sobre soporte técnico
            </p>
...
export default ServicioSoporteFAQ;