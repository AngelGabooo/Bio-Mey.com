      ...
      <div className="container-custom relative z-10 w-full max-w-[1400px]">
        <div className="grid grid-cols-1 lg:grid-cols-[45%_55%] gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          <div className="space-y-5 md:space-y-7 order-2 lg:order-1">
            ...
            >
              <span className="text-white">Soporte técnico</span>
              <br />
              <span className="text-white">rápido, confiable y</span>
              <br />
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-blue-200/70 text-xs">Atención rápida</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="text-blue-200/70 text-xs">Soporte remoto</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="text-blue-200/70 text-xs">Técnicos certificados</span>
              </div>
            </div>
          </div>
