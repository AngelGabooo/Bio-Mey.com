...
${form.mensaje}
  ...
  // Factores que influyen en el costo del soporte
  const factores = [
    {
  ...
  return (
    <section ref={sectionRef} className="relative py-10 md:py-16 bg-[#0a0a14] overflow-hidden" id="precios">
      {/* Glow de fondo */}
      ...
      <div className="container-custom relative z-10 max-w-6xl mx-auto px-5">
        ...
        {/* Dos columnas: factores + formulario */}
        <div
        ...
        >
          ...
          <div className="rounded-2xl border border-white/[0.08] bg-white/[0.02] p-6 md:p-8">
            <h3 className="text-xl md:text-2xl font-bold text-white mb-1">¿Qué influye en el costo</h3>
