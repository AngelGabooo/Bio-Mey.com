      ...
      <div className="container-custom relative z-10 w-full max-w-[1400px]">
        <div className="grid grid-cols-1 lg:grid-cols-[50%_50%] gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          <div className="space-y-5 md:space-y-7 order-2 lg:order-1">
            ...
            >
              <span className="text-gray-900">Desarrollamos aplicaciones</span>
              <br />
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-500 text-xs">Alto rendimiento</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-cyan-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
                <span className="text-gray-500 text-xs">100% Seguras</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-cyan-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="text-gray-500 text-xs">Diseño UX/UI</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-cyan-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-500 text-xs">Soporte 24/7</span>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center lg:justify-end -z-10">
              <div className="w-[350px] h-[350px] sm:w-[400px] sm:h-[400px] md:w-[500px] md:h-[500px] lg:w-[600px] lg:h-[600px] xl:w-[700px] xl:h-[700px] bg-gradient-to-r from-cyan-100/40 to-cyan-200/30 rounded-full blur-3xl lg:-mr-12"></div>
            </div>
            
            {/* Efectos decorativos - Cian */}
            <div className="absolute -top-12 -right-6 sm:-top-16 sm:-right-8 md:-top-20 md:-right-12 w-[150px] h-[150px] sm:w-[200px] sm:h-[200px] md:w-[250px] md:h-[250px] bg-cyan-100/40 rounded-full blur-3xl"></div>
            <div className="absolute -bottom-12 -right-4 sm:-bottom-16 sm:-right-6 md:-bottom-20 md:-right-8 w-[150px] h-[150px] sm:w-[200px] sm:h-[200px] md:w-[250px] md:h-[250px] bg-cyan-200/30 rounded-full blur-3xl"></div>
